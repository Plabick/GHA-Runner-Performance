...
if __name__ == "__main__":
    ...
    upload_chart = make_chart(history, "upload", "Upload Speed, Mb/s", 40)
    download_chart = make_chart(history, "download", "Download Speed, Mb/s", 40)
    ping_chart = make_chart(history, "ping", "Ping, ms", 40)
    ...
    print(f"::set-output name=uploadChart::{upload_chart}")
    print(f"::set-output name=downloadChart::{download_chart}")
    print(f"::set-output name=pingChart::{ping_chart}")
